    ...
    public static class GlobalWallShapeDefs
    {
        ...
        public static List<WallShapeDef> Defs = new List<WallShapeDef>()
        {
            new WallShapeDef()
            {
                ...
                UiPreviewSprite = Resources.Load<Sprite>(PreviewSpriteBasePath + "solid"),
            ...
            new WallShapeDef()
            {
                ...
                UiPreviewSprite = Resources.Load<Sprite>(PreviewSpriteBasePath + "corner"),
                IsClimbable = false,
                IsCornerShape = true,
            ...
            new WallShapeDef()
            {
                ...
                UiPreviewSprite = Resources.Load<Sprite>(PreviewSpriteBasePath + "slope"),
                IsClimbable = false,
            ...
            new WallShapeDef()
            {
                ...
                UiPreviewSprite = Resources.Load<Sprite>(PreviewSpriteBasePath + "window"),
                BlocksVision = false,
