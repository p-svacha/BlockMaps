...
namespace BlockmapFramework
{
    ...
    /// </summary>
    public class StraightAdjacentWalkTransition : Transition
    {
        public StraightAdjacentWalkTransition(BlockmapNode from, BlockmapNode to, Direction dir) : base(from, to)
        {
            Direction = dir;
        }
